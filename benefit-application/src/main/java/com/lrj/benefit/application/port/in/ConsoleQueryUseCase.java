...
public interface ConsoleQueryUseCase {
    ...
    List<SkuView> listSkus(String tenantId, int limit);
    ...
    record Overview(long unknownOps, long partialOrders, long pendingRemediations, long skuCount, long enabledRoutes) {}

    record TenantView(String tenantId, String homeCell, boolean enabled, long version) {}

    record SkuView(String skuId, String benefitType, Long faceValueMinor, String currency, boolean enabled, long version) {}
